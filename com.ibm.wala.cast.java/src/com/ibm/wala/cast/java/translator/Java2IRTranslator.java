...
public class Java2IRTranslator {
  ...
  private final JavaCAst2IRTranslator javaCAst2IRTranslator;
  ...
  public Java2IRTranslator(JavaSourceLoaderImpl srcLoader,
    ...
    javaCAst2IRTranslator = new JavaCAst2IRTranslator(srcLoader);
  ...
  public void translate(ModuleEntry module, CAstEntity ce) {
    ...
    javaCAst2IRTranslator.setModuleAndSourceFileEntity(module,ce);
    javaCAst2IRTranslator.translate();
