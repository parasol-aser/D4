...
public class JavaCAst2IRTranslator extends AstTranslator {
  private CAstEntity fSourceEntity;
...
//    this.module = module;
//  }
  public JavaCAst2IRTranslator(JavaSourceLoaderImpl loader) {
    super(loader);
  }
  ...
  public void setModuleAndSourceFileEntity(ModuleEntry module, CAstEntity entity)
  {
    this.module = module;
    this.fSourceEntity = entity;
  }
