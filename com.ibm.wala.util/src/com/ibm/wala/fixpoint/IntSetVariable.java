...
public abstract class IntSetVariable<T extends IntSetVariable> extends AbstractVariable<T> {
  ...
  public MutableSharedBitVectorIntSet removeSome(IntSet set){
    MutableSharedBitVectorIntSet removed = new MutableSharedBitVectorIntSetFactory().make();
    if(V != null && set!=null){
//      MutableSharedBitVectorIntSet vset = (MutableSharedBitVectorIntSet) V;
//      MutableSharedBitVectorIntSet that = (MutableSharedBitVectorIntSet) set;
//      IntSet intersection = vset.intersection(that);
//      BitVectorIntSet temp = new BitVectorIntSet(intersection);
//      ((MutableSharedBitVectorIntSet) V).removeIntersection(temp);
//      return (MutableSharedBitVectorIntSet) intersection;
